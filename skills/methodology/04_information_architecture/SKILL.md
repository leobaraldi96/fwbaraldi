...
3. **Layers Interaction Engine (`../05_interaction_design_ux/skills/methodology/05_interaction_design_ux/skills/engines/layers_interaction_engine/`):** Mandatorio para el **Momento 2**. Asegura que los flujos cubran validaciones, estados de error y todos los actores definidos.
...
---
*Framework Baraldi v2.26.13 · skills/methodology/04_information_architecture/SKILL.md*
