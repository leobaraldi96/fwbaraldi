...
### A. RICE Score (Rigor de Crecimiento)
Ideal para productos con data abundante y objetivos de Growth.
- **Reach:** Alcance proyectado.
- **Impact:** Mejora de métrica (1 a 3).
- **Confidence:** Certeza de los datos (50% a 100%).
- **Effort:** Inversión en meses/persona.
- **Fórmula:** `(R x I x C) / E`

### B. Modelo Kano (Diferenciación y Deleite)
Ideal para lanzamientos de marca o rediseños competitivos.
- **Básicos:** Lo que el usuario espera por defecto.
- **Performance:** Lo que mejora la satisfacción proporcionalmente.
- **Delighters:** El factor "Wow" que genera lealtad.

### C. Baraldi Master Matrix (Filtro Rápido)
Ideal para alineación estratégica en fases tempranas.
...
- **Strategic Investments:** Alto Valor / Alto Esfuerzo. (Planificar con rigor).
- **Maybes:** Bajo Valor / Bajo Esfuerzo. (Backlog de relleno).
...
- **SIEMPRE** vincula la priorización a la **Etapa 01 (Contexto)** para asegurar alineación con la North Star.
...
---
*Framework Baraldi v2.26.13 · Skill 02 · Priorización Estratégica*
