...
- **Cierre Diagnóstico:** Si el cliente no está listo para una solución integral, pivotar hacia auditorías pagadas o fases de descubrimiento (Fase 0).
...
- **Output:** Informe de "Procesos Automatizables" y lista de "Fricciones de Ingreso".

### B. Ingeniería de ROI (/biz-accountant)
Justificación económica de la inversión técnica.
- **Fase 0 (Discovery):** Validación de hipótesis con mínima inversión.
- **Fase 1 (CAPEX):** Inversión inicial en construcción.
- **Fase 2 (OPEX):** Costos operativos y evolución del valor.
...
- **SIEMPRE** valida que el modelo de negocio sea escalable sin depender de procesos manuales críticos.
...
---
*Framework Baraldi v2.26.14 · Skill 09 · Estrategia de Negocio*
